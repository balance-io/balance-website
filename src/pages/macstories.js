...
const Macstories = ({ data }) => (
  <div>
    <Helmet title={`Macstories - ${data.site.siteMetadata.title}`} />
    <Header theme={layoutTheme} />
    <SSection id="macstories" color={colors.navyBlue} background={<SBackgroundImage />}>
      <SSectionWrapper>
        <SHalf>
          <SSubscribe>
            <SFormWrapper>
...
export default Macstories;

export const query = graphql`
  query MacstoriesQuery {
    site {
      siteMetadata {
        title
      }
