...
const Appstories = ({ data }) => (
  <div>
    <Helmet title={`Appstories - ${data.site.siteMetadata.title}`} />
    <Header theme={layoutTheme} />
    <SSection id="appstories" color={colors.navyBlue} background={<SBackgroundImage />}>
      <SSectionWrapper>
        <SHalf>
          <SSubscribe>
            <SFormWrapper>
